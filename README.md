...
Вы можете запустить проект локально, клонировав его репозиторий и открыв index.html в вашем браузере. Также вы можете посмотреть его онлайн на GitHub Pages по [ссылке](https://yankarpov.github.io/First-CSS-animation/).
